...
// Netlist written on Thu Mar 26 14:23:39 2026
...
//
// Verilog Description of module i3c_s
// module wrapper written out since it is a black-box. 
//

//

module i3c_s (scl_io, sda_io, rst_n_i, clk_i, int_o, tgt_rst_o, 
            apb_penable_i, apb_psel_i, apb_pwrite_i, apb_paddr_i, apb_pwdata_i, 
            apb_pready_o, apb_pslverr_o, apb_prdata_o) /* synthesis ORIG_MODULE_NAME="i3c_s", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    inout scl_io;
    inout sda_io;
    input rst_n_i;
    input clk_i;

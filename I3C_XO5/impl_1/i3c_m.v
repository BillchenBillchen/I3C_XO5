...
// Netlist written on Fri Mar 13 16:33:44 2026
...
//
// Verilog Description of module i3c_m
// module wrapper written out since it is a black-box. 
//

//

module i3c_m (clk_i, rst_n_i, scl_io, sda_io, int_o, apb_penable_i, 
            apb_psel_i, apb_pwrite_i, apb_paddr_i, apb_pwdata_i, apb_pready_o, 
            apb_pslverr_o, apb_prdata_o) /* synthesis ORIG_MODULE_NAME="i3c_m", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input clk_i;
    input rst_n_i;
    inout scl_io;
    inout sda_io;

...
`ifdef LFMXO4
    GSR GSR_INST (.CLK(1'b0), .GSR  (1'b1));
...
always @ (posedge ahbl_hclk_i) begin
  ...
  lscc_aximem_manager # (
    ...
    .axi_m0_awlock_o        (axi_s0_awlock_i),
    ...
    .axi_m0_arlock_o        (axi_s0_arlock_i),
  ...
  if (PORT_COUNT == 2) begin
    lscc_aximem_manager # (
      ...
      .axi_m0_awlock_o        (axi_s1_awlock_i),
      ...
      .axi_m0_arlock_o        (axi_s1_arlock_i),

...
#define CPU_INST_0_UART_IRQ                CONFIG_DEF(RISCV_RTOS_INST_0, IRQ)
#endif
...
#define OCTAL_SPI_CONTROLLER_INST_0_MEM_MAP_NUM          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, MEM_MAP_NUM)
#if (OCTAL_SPI_CONTROLLER_INST_0_MEM_MAP_NUM > 1)
#define OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_AXI4_MAP          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, OCTAL_SPI_CONTROLLER_AXI4_MAP)
#define OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_AXI4C_MAP          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, OCTAL_SPI_CONTROLLER_AXI4C_MAP)
#define OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_APB_MAP          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, OCTAL_SPI_CONTROLLER_APB_MAP)

#if OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_AXI4_MAP
#define OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_AXI4_MAP_BASE_ADDR          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, OCTAL_SPI_CONTROLLER_AXI4_MAP_BASE_ADDR)
#endif

#if OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_AXI4C_MAP
#define OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_AXI4C_MAP_BASE_ADDR          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, OCTAL_SPI_CONTROLLER_AXI4C_MAP_BASE_ADDR)
#endif

#if OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_APB_MAP
#define OCTAL_SPI_CONTROLLER_INST_0_OCTAL_SPI_CONTROLLER_APB_MAP_BASE_ADDR          CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, OCTAL_SPI_CONTROLLER_APB_MAP_BASE_ADDR)
#endif
#else /*OCTAL_SPI_CONTROLLER_INST_0_MEM_MAP_NUM <= 1*/
...
#define OCTAL_SPI_CONTROLLER_INST_0_MAX_NUMLANE   CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, MAX_NUMLANE)
#define OCTAL_SPI_CONTROLLER_INST_0_CLKI_FREQ   CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, CLKI_FREQ)
#define OCTAL_SPI_CONTROLLER_INST_0_SPI_SCKDIV   CONFIG_DEF(OCTAL_SPI_CONTROLLER_INST_0, SPI_SCKDIV)
#endif
